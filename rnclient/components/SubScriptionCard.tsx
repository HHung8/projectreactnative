...
const SubScriptionCard = ({ name, price, icon, billing, currency, color, status, category, plan, expanded, renewalDate, onPress, paymentMethod, startDate }: SubscriptionCardProps) => {
    return (
